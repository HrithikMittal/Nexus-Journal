      ...
      .toArray(function (err, result) {
        ...
        for (i = 0; i < result.length; i++) {
          if (result[i].nameledger == casht.fromname) {
            ...
            newdebit = result[i].debitamount;
            setamount = parseInt(setamount);
        ...
        if (flag == 0) {
          ...
          newcredit = parseInt(value5);
          ledgera.creditamount = newcredit;
          newdebita = 0;
          ...
          setamountintial = parseInt(setamountintial);
          newdeb = 0;
